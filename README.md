<p align="center">
    <a href="https://github.com/MCF-Org/WZ-X">
        <kbd>
...
[![GitHub forks](https://img.shields.io/github/forks/weebzone/WZML?style=social)](https://github.com/MCF-Org/WZ-X/fork)
...
### ***Source Code*** : [Repo](https://github.com/MCF-Org/WZ-X)
...
### 1. [***Getting Started***](https://github.com/MCF-Org/WZ-X/wiki/Getting-Started)
Introduction To the Bot

### 2. [***Features***](https://github.com/MCF-Org/WZ-X/wiki/Features)
List of features supported by bot

### 3. [***config.env Variables***](https://github.com/MCF-Org/WZ-X/wiki/Setting-up-the-config.env-file)
List of Variables used by the Bot

### 4. [***Deploy***](https://github.com/MCF-Org/WZ-X/wiki/Deployment)
...
Copyright (C) 2022 WeebZone
    ...
    along with this program. < https://github.com/MCF-Org/WZ-X/blob/update/LICENSE >.
```
